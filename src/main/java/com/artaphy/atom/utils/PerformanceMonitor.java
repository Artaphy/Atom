package com.artaphy.atom.utils;

import com.artaphy.atom.Atom;
...
public class PerformanceMonitor {
    ...
    private static final Logger logger = Atom.getInstance().getLogger();
     ...
     * Logs a warning if execution time exceeds the threshold
     *
     * @param operationName The unique identifier for the operation
    ...
    public static void stopTiming(String operationName) {
        ...
        // Log warning if execution time exceeds the threshold
    ...
    private static void startMemoryMonitor() {
        ...
        }.runTaskTimer(Atom.getInstance(), MONITOR_INTERVAL, MONITOR_INTERVAL);
    }

    /**
     * Check current memory usage and log warning if it exceeds the threshold
     */
